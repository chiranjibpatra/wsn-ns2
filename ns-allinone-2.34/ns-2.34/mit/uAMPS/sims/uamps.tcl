...
set opt(quiet)        0                   ;# 0=print info, 1=quiet
...
set opt(mac)          Mac/Tdma        ;# Sensor mac protocol
set opt(ifq)          Queue/DropTail/PriQueue      ;# DropTail Q
...
proc sens_init {} {
    ...
    catch "eval exec rm [glob -nocomplain $opt(dirname)/Distance.*.txt]"
    ...
    puts "Creating sensor nodes... - uAMPS.tcl"
