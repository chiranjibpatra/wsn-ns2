...
source /home/chiranjib/ns-allinone-2.34/ns-2.34/mit/uAMPS/ns-ranode.tcl

#source $env(uAMPS_LIBRARY)/ns-bsapp.tcl

source /home/chiranjib/ns-allinone-2.34/ns-2.34/mit/uAMPS/ns-bsapp.tcl

#source $env(uAMPS_LIBRARY)/extras.tcl

source /home/chiranjib/ns-allinone-2.34/ns-2.34/mit/uAMPS/extras.tcl

#source $env(uAMPS_LIBRARY)/stats.tcl

source /home/chiranjib/ns-allinone-2.34/ns-2.34/mit/uAMPS/stats.tcl
...
source /home/chiranjib/ns-allinone-2.34/ns-2.34/mit/rca/resources/ns-resource-manager.tcl

#source $env(RCA_LIBRARY)/resources/ns-energy-resource.tcl

source /home/chiranjib/ns-allinone-2.34/ns-2.34/mit/rca/resources/ns-energy-resource.tcl

#source $env(RCA_LIBRARY)/resources/ns-neighbor-resource.tcl

source /home/chiranjib/ns-allinone-2.34/ns-2.34/mit/rca/resources/ns-neighbor-resource.tcl
...
set opt(CSThresh)      1e-6               ;# Receive threshold is 1 nW
set opt(RXThresh)      6e-6               ;# Success threshold is 6 nW
set PI                 3.1415926
...
set opt(Esense)        0.5                  ;# Sensing energy (J/bit)
set opt(thresh_energy) 0.05                  ;# Threshold for power adaptation
set opt(Pidle)         0.00                  ;# Idle power (W)
set opt(Psleep)        0.00                  ;# Sleep power (W)
...
Agent/RCAgent set source_          0
Agent/BSAgent set packetMsg_       0
Agent/BSAgent set source_          0
