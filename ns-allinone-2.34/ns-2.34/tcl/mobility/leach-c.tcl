...
puts $outf "advertising info time:$opt(adv_info_time)\n"
puts $outf "Num iters for sim. annealing alg:$opt(bs_setup_iters)\n"
puts $outf "NMax change for sim. annealing alg.:$opt(bs_setup_max_eps)\n"
close $outf
